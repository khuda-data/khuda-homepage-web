...
export const KHUDA_FEATURES: FeatureInfo[] = [
  {
    ...
    details: "ML·DL 핵심 개념 학습, 파이썬 실습, 그리고 팀 단위 토이 프로젝트를 통해 이론과 실전을 동시에 경험합니다.",
  ...
  },
  {
    ...
    details: "6개 트랙에서 관심 분야를 선택하여 체계적인 커리큘럼을 통해 전문성을 기르고, 트랙원들과 함께 프로젝트를 진행합니다.",
    image: "/images/activities/track-session-1.jpg",
  },
  {
    title: "정기 학술제",
    label: "성과",
    description: "한 학기 동안 완성한 프로젝트를 발표하는 KHUDA의 최종 컨퍼런스 활동입니다.",
    details: "최종 발표를 통해 심사위원분들의 피드백을 받으며 프로젝트의 완성도를 높입니다.",
