...
export const APPLICATION_FORM_CONFIG = {
  ...
  obBenefits: {
    ...
    benefits: [
      ...
      {
        title: "3. OB 심화 활동",
        description: "OB를 대상으로 운영되는 심화 활동입니다. 논문·프로젝트를 팀 단위로 진행하며 KSC·공모전 등 대내외 대회에 출전하고, 졸업생·KHUDA 출신 석박사·교수님 멘토진이 주기적으로 피드백을 제공합니다. (OB 심화 활동 인원은 별도 선발 절차를 거쳐 모집할 예정입니다)",
      },
      {
        title: "4. 정기 학술제 참여",
