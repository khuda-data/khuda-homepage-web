// 인덱스 페이지 TrackShowcase용 간결한 트랙 데이터
...
직접 설명회를 진행합니다. 본격적인 트랙 선택을 위한 정보를 얻을 수 있습니다.`,
  ...
  academicFestival: {
    ...
    description: "트랙별 1-2팀을 구성해 팀 단위 프로젝트를 수행하고, 학술 포스터 제작과 프로젝트 발표를 진행합니다. 프로젝트를 공유하고 설명하는 경험을 통해 사고의 깊이와 표현력을 함께 성장시킵니다. 여기에 교수님을 비롯해 현직자 분들이 심사위원으로 참여합니다.",
    participation: {
      title: "참여 인원",
