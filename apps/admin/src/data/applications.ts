...
export const mockApplications: Application[] = [
  ...
  },
  {
    ...
    name: "윤재호",
    phone: "010-9012-3456",
    email: "jaeho.yoon@khu.ac.kr",
    applicationType: "yb",
    track: "데이터베이스",
    submittedAt: "2026-06-24T13:48:00+09:00",
    answers: [
      ...basic("정보디스플레이학과", "2학년"),
      ...common("데이터 모델링 기초를 다지고 싶어 지원했습니다.", "기록과 정리를 좋아합니다."),
      ...ybType("엑셀과 간단한 SQL을 다뤄봤습니다.", "기초 세션을 따라가며 ERD를 직접 그려보고 싶습니다."),
    ],
    interviewTimes: ["2026-06-28 16:00"],
  },
  {
    id: "app-010",
    name: "임수아",
    phone: "010-0123-4567",
    email: "sua.lim@khu.ac.kr",
    applicationType: "ob",
    track: "AI 엔지니어링",
    submittedAt: "2026-06-24T19:30:00+09:00",
    answers: [
      ...basic("컴퓨터공학과", "3학년"),
      ...common("모델 서빙 경험을 넓히고 싶어 지원했습니다.", "배포와 운영에 관심이 많습니다."),
      ...obType("FastAPI로 추론 서버를 구축한 경험이 있습니다.", "서빙 파이프라인과 모니터링 구성을 도울 수 있습니다."),
    ],
    interviewTimes: ["2026-06-29 17:00", "2026-06-29 17:20"],
  },
  {
    id: "app-011",
    name: "강민준",
    phone: "010-1357-2468",
    email: "minjun.kang@khu.ac.kr",
    applicationType: "yb",
    track: "금융 AI",
    submittedAt: "2026-06-25T10:10:00+09:00",
    answers: [
      ...basic("경영학과", "1학년"),
      ...common("금융 데이터에 처음 입문해보고 싶어 지원했습니다.", "숫자 감각이 있는 편입니다."),
      ...ybType("통계 수업을 들은 정도입니다.", "기초 세션으로 데이터 분석 흐름을 익히고 싶습니다."),
    ],
    interviewTimes: ["2026-06-30 14:00"],
  },
  {
    id: "app-012",
    name: "서지우",
    phone: "010-2468-1357",
    email: "jiwoo.seo@khu.ac.kr",
    applicationType: "ob",
    track: "NLP",
    submittedAt: "2026-06-25T15:55:00+09:00",
    answers: [
      ...basic("언어학과", "4학년"),
      ...common("LLM 활용 프로젝트를 해보고 싶어 지원했습니다.", "언어 데이터 해석에 강점이 있습니다."),
      ...obType("챗봇 프로토타입을 만들어본 경험이 있습니다.", "프롬프트 설계와 평가 기준 수립을 도울 수 있습니다."),
    ],
    interviewTimes: ["2026-06-30 16:00", "2026-06-30 16:20"],
  },
  {
    id: "app-013",
    name: "조하린",
    phone: "010-3691-2580",
    email: "harin.cho@khu.ac.kr",
    applicationType: "yb",
    track: "CV",
    submittedAt: "2026-06-26T09:20:00+09:00",
    answers: [
      ...basic("미디어학과", "2학년"),
      ...common("이미지 데이터를 다뤄보고 싶어 지원했습니다.", "꾸준히 기록하며 학습합니다."),
      ...ybType("포토샵과 파이썬 입문 경험이 있습니다.", "기초 세션을 완주하고 토이 프로젝트에 참여하고 싶습니다."),
    ],
    interviewTimes: ["2026-06-28 17:00"],
  },
];
